...
export_dir = r"F:\My Drive\Percentile Reports\High School"
...
#     doc = Document()
#
#     # Add an image at the top center
#     doc.add_picture('8ctane - Faded 8 to Blue.png', width=Inches(6), height=Inches(4))
#     last_paragraph = doc.paragraphs[-1]
#     last_paragraph.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
#
#     # Add 'Player Name:' aligned to the right
#     player_name = doc.add_paragraph()
#     player_name.alignment = WD_PARAGRAPH_ALIGNMENT.RIGHT
#     player_name.add_run('Player Name:').bold = True
#
#     # Add 'Date:' with the session_data_id
#     date_paragraph = doc.add_paragraph()
#     date_paragraph.alignment = WD_PARAGRAPH_ALIGNMENT.RIGHT
#     date_paragraph.add_run('Date:').bold = True
#     date_paragraph.add_run(f' {session_data_id}')
#
#     # Add a page break
#     doc.add_page_break()
#
...
#     pdf_pages = PdfPages(pdf_filename)
#
#     # Rest of your code for generating histograms...
#
#     # Close the PDF pages
#     pdf_pages.close()
#
