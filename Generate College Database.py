...
conn = sqlite3.connect("grading_equation_reference_data_College.db")
cursor = conn.cursor()
...
directory_path = r"C:\Users\q\PycharmProjects\Rename_Session.xml\Pitching Data\Kinematic Data\College"
